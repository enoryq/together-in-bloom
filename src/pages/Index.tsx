  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-semibold mb-4">AI Relationship Companion</h3>
              <p className="text-muted-foreground mb-6 text-lg leading-relaxed">
                Get personalized relationship advice, exercises, and insights from your AI companion. 
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <FeatureCard 
            ...
            description="Get personalized advice, exercises, and insights from your AI companion available 24/7."
            highlight="NEW"
          />
          <FeatureCard 
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <TestimonialCard 
            quote="The AI companion helped us navigate our biggest challenge yet. It's like having a relationship therapist available anytime."
            author="Sarah & Mike"
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-primary to-purple-600 py-16 text-white text-center">
        <div className="container mx-auto px-4">
